...
return [
    'regsite' => 'https://dev:stage1@dev-my.advpartners.pro/',
    'i18nprojectCode' => 'WEBCLIENTSITE',
    'showdots' => 1,
    'capcha_client'=>'6LcqOL8UAAAAAGOLE08gjlEJsEiScGiDCyXVRpzv',
    'capcha_secret'=>'6LcqOL8UAAAAAGHnZI0-SJp6ygPyGoUYDcgXOlwS',
    'social' => [
       'vk'=> [
           'client_id'=>'6242109',
 ...
 // 'lkApiUrl' => 'http://api.lk2.lc',
   'lkApiUrl' => 'https://dev:stage1@dev-client-api.advpartners.pro', 
   'lkApiUrlAuth' => [],
   'I18N_PROJECT_ID' => 4,
   'languages' => [[
       'id' => 1,
